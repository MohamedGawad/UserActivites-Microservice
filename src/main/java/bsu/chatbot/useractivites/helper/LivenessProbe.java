...
import bsu.chatbot.useractivites.controller.UserActivityController;
...
public class LivenessProbe implements HealthCheck {
	...
	public HealthCheckResponse call() {
		...
		try {
			...
			if (UserActivityController.isHealthy()) {
				builder = builder.up();
			...
			builder = builder.withData("consecutiveErrors", UserActivityController.consecutiveErrors);
